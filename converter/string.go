...
func (s *stringConverter) CanConvert(m marker.Marker, def *definition.Definition) error {
...
func (s *stringConverter) Convert(m marker.Marker, def *definition.Definition) (reflect.Value, error) {
	return s.str(m, def)
}

func (s *stringConverter) str(m marker.Marker, def *definition.Definition) (reflect.Value, error) {
