...
func (b *boolConverter) CanConvert(m marker.Marker, def *api.Definition) error {
...
func (b *boolConverter) Convert(m marker.Marker, def *api.Definition) (reflect.Value, error) {
